    ...
    , ui(new Ui::Widget)
{
    ...
    // Заполняем ComboBox со стилями
    ui->styleComboBox->addItem("windowsvista");
    ui->styleComboBox->addItem("Windows");
    ui->styleComboBox->addItem("Fusion");
    ui->styleComboBox->addItem("MyStyle");
    ...
    // При выборе пользователем стиля приложения
    connect(ui->styleComboBox, &QComboBox::currentTextChanged, this, [this](QString style) {
         if(style == "MyStyle") {
             // Устанавливаем разработанные стили
             ...
             qApp->setStyleSheet(styleSheet());
             QStyle* styleSheet = QStyleFactory::create(style);
